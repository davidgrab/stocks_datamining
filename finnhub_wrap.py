########################################################
#                                                      #
#   Financial Data Hub - Democratize Financial Data    #
#                                                      #
#   Real-Time RESTful APIs for                         #
#   Stocks, Currencies, and Crypto.                    #
#                                                      #
#   The API is organized around REST. Our API has      #
...
#   authentication, and verbs. This is 1 of the most   #
#   comprehensive financial API available              #
#   on the market.                                     #
#                                                      #
...
########################################################
#   DISCLAIMER:                                        #
#   THIS API IS A FREE IMPLEMENTATION AND NOT          #
#   RELATED TO FINNHUB.IO OR ITS TEAM MEMBERS!         #
########################################################
#   MIT License                                        #
#   Copyright (c) 2019 Michael-André Wagner            #
#   https://github.com/wagnerio/finnhub-api-wrapper    #
########################################################
...
class FinnHub:
    ...
    def get_stock_company_profile_2(self, symbol):
        """Get general information of a company."""

        params = {'symbol': symbol}
        return self.call_api('/stock/profile2', params)

    def financial_stetments(self, symbol):
        """Get general information of a company."""
        params = {'symbol': symbol,'freq':'quarterly'}
        return self.call_api('/stock/financials-reported', params)
    ...
    def get_stock_earnings(self, symbol):
        ...
        params = {'symbol': symbol}
        return self.call_api('/calendar/earnings', params)
    ...
    def get_company_news(self, symbol,fromm,too):
        """List latest company news by symbol.
        This endpoint is only available for US companies."""
        params = {'symbol': symbol,'from':fromm,'to':too}
        return self.call_api('/company-news', params)
    ...
    def get_stock_margin_matric(self, symbol):
        """Get recent and coming ICO."""
        params = {'symbol': symbol, 'metric': 'margin'}
        return self.call_api('/stock/metric', params)

    def get_stock_price_matric(self, symbol):
        """Get recent and coming ICO."""
        params = {'symbol': symbol, 'metric': 'price'}
        return self.call_api('/stock/metric', params)

    def get_stock_last_quote(self, symbol):
        """Get recent and coming ICO."""
        params = {'symbol': symbol}
        return self.call_api('/quote', params)

    def get_stock_growth_matric(self, symbol):
        """Get recent and coming ICO."""
        params = {'symbol': symbol, 'metric': 'growth'}
        return self.call_api('/stock/metric', params)

    def get_stock_management_matric(self, symbol):
        """Get recent and coming ICO."""
        params = {'symbol': symbol, 'metric': 'management'}
        return self.call_api('/stock/metric', params)
